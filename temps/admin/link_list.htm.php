...
<td valign="top">
<div class='title'>
<a href="?sort=game_flat&action=links&do=link_add"><?php echo $this->_var['language']['link_add']; ?></a>
...
?>
	...
	<a href="?sort=game_flat&action=links&do=link_edit&link_id=<?php echo $this->_var['link']['id']; ?>"><?php echo $this->_var['language']['edit']; ?></a>
	<a href="?sort=game_flat&action=links&do=link_delete&link_id=<?php echo $this->_var['link']['id']; ?>" onclick="return confirm('<?php echo $this->_var['language']['confirm_delete']; ?>')"><?php echo $this->_var['language']['delete']; ?></a>
	</td>
	</tr>
