...
<td valign="top">
<div class='title'>
<a href="?sort=game_flat&action=news&do=content_add&channel_id=<?php echo $this->_var['channel_id']; ?>"><?php echo $this->_var['language']['content_add']; ?></a>
...
?>
	...
	<?php if ($this->_var['content']['category_name']): ?>
		[<a href="?sort=game_flat&action=news&do=content_list&channel_id=<?php echo $this->_var['content']['channel_id']; ?>&content_id=<?php echo $this->_var['content']['id']; ?>&category_id=<?php echo $this->_var['content']['category_id']; ?>" style="font-weight:bold;color:green"><?php echo $this->_var['content']['category_name']; ?></a>]
	<?php endif; ?>
	<a href="?sort=game_flat&action=news&do=content_edit&channel_id=<?php echo $this->_var['content']['channel_id']; ?>&content_id=<?php echo $this->_var['content']['id']; ?>"><?php echo $this->_var['content']['title']; ?></a>
	...
	(<a href="?sort=game_flat&action=news&do=comment_list&content_id=<?php echo $this->_var['content']['id']; ?>"><?php echo $this->_var['content']['comment_count']; ?></a>)
	<?php endif; ?>
