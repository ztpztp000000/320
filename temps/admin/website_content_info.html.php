...
<td valign="top">
<div class='title'>
<a href="?sort=websites&action=content&channel_id=<?php echo $_REQUEST['channel_id']; ?>"><?php echo $this->_var['language']['content_list']; ?></a>
...
<div class='item'>
<form action="?sort=websites&action=content&do=content_<?php echo $this->_var['mode']; ?>" method="post" enctype="multipart/form-data" name="content_info">
...
?>
		<option value="<?php echo $this->_var['game']['id']; ?>" <?php if ($this->_var['content']['game_id'] == $this->_var['game']['id']): ?>selected<?php endif; ?>><?php echo $this->_var['game']['name']; ?></option>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</select>
  		</td>
		</tr>
