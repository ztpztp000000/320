...
<td valign="top">
<div class='title'>
<a href="?sort=game_flat&action=channel&do=channel_add"><?php echo $this->_var['language']['channel_add']; ?></a>
&raquo;&nbsp;<?php echo $this->_var['language']['channel_list']; ?>
</div>
	<table cellspacing="0" cellpadding="0" width="100%">
	<?php $_from = $this->_var['channel_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'channel');if (count($_from)):
    foreach ($_from AS $this->_var['channel']):
?>
		<tr>
		<td height="40" width="30" align="center"><?php echo $this->_var['channel']['id']; ?></td>
		<td><a href="?sort=game_flat&action=channel&do=content_list&channel_id=<?php echo $this->_var['channel']['id']; ?>"><?php echo $this->_var['channel']['name']; ?></a>&nbsp;<span style="color:#ccc">(<?php echo $this->_var['channel']['description']; ?>)</span></td>
		<td height="40" width="200" align="center">
		<a href="?sort=game_flat&action=channel&do=channel_edit&channel_id=<?php echo $this->_var['channel']['id']; ?>"><?php echo $this->_var['language']['edit']; ?></a>
		<a href="?sort=game_flat&action=channel&do=channel_delete&channel_id=<?php echo $this->_var['channel']['id']; ?>" onclick="return confirm('<?php echo $this->_var['language']['confirm_delete']; ?>')"><?php echo $this->_var['language']['delete']; ?></a>
		</td>
		</tr>
