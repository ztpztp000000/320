...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
				  <tr>
					...
					<td><?php echo $this->_var['splog']['total']; ?>元</td>
				  </tr>
				  <tr>
				    <td align="right">分成比例：</td>
				    <td><?php echo $this->_var['splog']['sper']; ?>%</td>
	      </tr>
				  <tr>
				    <td align="right">已提现金额：</td>
				    <td><?php echo $this->_var['splog']['cash']; ?>元&nbsp;&nbsp;<a href="user.php?action=cash_log">(查看记录)</a></td>
			      </tr>
				  <tr>
				    <td align="right">可提现金额：</td>
				    <td><?php echo $this->_var['splog']['free']; ?>元</td>
			      </tr>
			</table>
				<br />
		        <form id="form1" name="form1" method="post" action="user.php?action=cash">
		          <table width="100%" border="0" cellspacing="2" cellpadding="2">
                    <tr>
                      <td width="20%" align="right">姓名：</td>
                      <td><input type="text" name="member_name" value="<?php echo $this->_var['member']['name']; ?>" /> *提现资料必须填写完整</td>
                    </tr>
                    <tr>
                      <td align="right">身份证：</td>
                      <td><input type="text" name="member_card" value="<?php echo $this->_var['member']['card']; ?>" /></td>
                    </tr>
                    <tr>
                      <td align="right">开户银行：</td>
                      <td><input type="text" name="member_bank" value="<?php echo $this->_var['member']['bank']; ?>" /></td>
                    </tr>
                    <tr>
                      <td align="right">银行卡号：</td>
                      <td><input type="text" name="member_bankno" value="<?php echo $this->_var['member']['bankno']; ?>" /></td>
                    </tr>
                    <tr>
                      <td align="right">联系电话：</td>
                      <td><input type="text" name="member_phone" value="<?php echo $this->_var['member']['phone']; ?>" /></td>
                    </tr>
                    <tr>
                      <td align="right">提现金额： </td>
                      <td><input type="text" name="cash" value="<?php echo $this->_var['splog']['free']; ?>" /></td>
                    </tr>
                    <tr>
                      <td align="right">&nbsp;</td>
                      <td><input type="submit" name="Submit" value="申请提现" /><input type="submit" name="Submit" value="申请提取平台币" /></td>
                    </tr>
                  </table>
		        </form>
				<br />
