...
case 'start':
	...
	exit;
case 'game_flat':
	include'admin_flat.php';
	exit;
case 'websites':
	include'admin_websites.php';
	exit;
case 'user':
...
if ('game_website'==$action)
{
	include'admin_game_website.php';
	exit;
}*/

function smarty_header(){
	$GLOBALS['smarty']->template_dir	=ROOT_PATH.'templates/new_admin';
	$GLOBALS['smarty']->cache_dir		=ROOT_PATH.'temps/admin';
	$GLOBALS['smarty']->compile_dir	=ROOT_PATH.'temps/admin';
	$GLOBALS['smarty']->assign('language',$GLOBALS['language']);
	//var_dump($GLOBALS['language']);exit;
	//$GLOBALS['smarty']->assign('config',$GLOBALS['config']);
}
function message($message=array()){
	$smarty=new smarty();
	$smarty->template_dir	=ROOT_PATH.'templates/new_admin';
	$smarty->cache_dir		=ROOT_PATH.'temps/admin';
	$smarty->compile_dir	=ROOT_PATH.'temps/admin';
